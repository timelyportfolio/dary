      ...
      renderValue: function(x) {
        ...
        var options = {
          ...
          fontFamily: "Ubuntu Mono"
				...
				// add in other options provided by user through ...
				//  override defaults if user has provided an option
				if(x.options) {
				  options = Object.assign(options, x.options);
				}
        ...
        if(HTMLWidgets.shinyMode  && window.Shiny && Shiny.setInputValue) {
